...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers("/api/user/request").hasAnyRole(Role.ADMIN.name(),Role.MOD.name(),Role.USER.name(),Role.DJ.name(),Role.SUPERDJ.name())
                .antMatchers("/api/user/track/*").hasAnyRole(Role.ADMIN.name(),Role.MOD.name(),Role.USER.name(),Role.DJ.name(),Role.SUPERDJ.name())
                .antMatchers("/api/user/**").hasAnyRole(Role.ADMIN.name())
                .antMatchers("/api/expenditure").hasAnyRole(Role.ADMIN.name(), Role.MOD.name())
                .antMatchers("/api/expenditure/**").hasAnyRole(Role.ADMIN.name(), Role.MOD.name())
                .antMatchers(HttpMethod.POST,"/api/spotify/song/skipVote").hasAnyRole(Role.ADMIN.name(),Role.USER.name(),Role.MOD.name(),Role.DJ.name(),Role.SUPERDJ.name())
                .antMatchers(HttpMethod.POST,"/api/spotify/song").hasAnyRole(Role.ADMIN.name(),Role.USER.name(),Role.MOD.name(),Role.DJ.name(),Role.SUPERDJ.name())
                .antMatchers(HttpMethod.GET,"/api/spotify/song").hasAnyRole(Role.ADMIN.name(),Role.USER.name(),Role.MOD.name(),Role.DJ.name(),Role.SUPERDJ.name())
